            ...
            <div className="bg-white rounded-xl shadow-md p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center px-6 py-3 bg-[var(--color-green)] text-white font-medium rounded-lg hover:bg-[var(--color-darkGreen)] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-green)] disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
