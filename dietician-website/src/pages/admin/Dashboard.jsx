          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                ...
                <Link
                  to="/admin/plans"
                  className="flex items-center justify-between w-full px-4 py-3 bg-white border-2 border-gray-100 text-gray-700 rounded-lg hover:border-green-500 hover:text-green-600 transition-all duration-200"
                >
                  <div className="flex items-center">
                ...
                <Link
                  to="/admin/services"
                  className="flex items-center justify-between w-full px-4 py-3 bg-white border-2 border-gray-100 text-gray-700 rounded-lg hover:border-blue-500 hover:text-blue-600 transition-all duration-200"
                >
                  <div className="flex items-center">
              ...
              <div className="pt-4 border-t border-gray-200 mt-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="bg-green-100 p-2 rounded text-center">
                    ...
                    <span className="font-bold text-green-600">{stats?.totalPlans ?? '--'}</span>
                  </div>
                  <div className="bg-blue-100 p-2 rounded text-center">
                    <span className="block text-xs text-gray-500">Total Services</span>
                    <span className="font-bold text-blue-600">{stats?.totalServices ?? '--'}</span>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-3">
                    {recentBlogs.map((blog) => (
                      <Link
                        key={blog.id}
                        to={`/blogs/${blog.id}`}
                        className="block p-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:shadow-md transition-all duration-200 group"
                      >
                  ...
                  <div className="space-y-3">
                    {recentTestimonialsData.map((testimonial) => (
                      <Link
                        key={testimonial.id}
                        to={`/admin/testimonials`}
                        className="block p-3 border border-gray-200 rounded-lg hover:border-purple-500 hover:shadow-md transition-all duration-200 group"
                      >
                        <div className="flex gap-3">
                          {testimonial.image && (
                            <div className="flex-shrink-0 w-16 h-16 rounded-lg overflow-hidden">
                  ...
                  <div className="space-y-3">
                    {recentTransformationsData.map((transformation) => (
                      <Link
                        ...
                        to={`/admin/testimonials`}
                        className="block p-3 border border-gray-200 rounded-lg hover:border-orange-500 hover:shadow-md transition-all duration-200 group"
                      >
                        <div className="flex gap-3">
